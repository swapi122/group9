...
class hotro_onlinemodule {
	function name() { return "Hỗ trợ online module"; }
	function description() { return "Quản lý việc tạo hỗ trợ online"; }
	...
	function show($view,$loc = null, $title = "") {
		...
		$template = new template('hotro_onlinemodule',$view,$loc);
