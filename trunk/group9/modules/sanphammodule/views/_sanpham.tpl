...
<a href="{link action=view_detail module=sanphammodule id=$sanpham->id}"  onmouseover="Tip('{$sanpham->chitiet|escape:'quotes':'UTF-8'}',TITLE, '<div align=center>{$sanpham->name|escape:'quotes':'UTF-8'}</div>' , BGCOLOR, '#4a4542', FONTCOLOR, '#FFFFFF', BORDERCOLOR, '#f79226', FADEIN, 150, FADEOUT, 100)" onmouseout="UnTip()">
<img src="{$sanpham->pic_path}" border=0 width=100 height=100>
</a>
					  </td>
</tr>
</tbody>
