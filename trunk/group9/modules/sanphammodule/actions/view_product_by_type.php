...
if (!defined("EXPONENT")) exit("");
	...
	if (isset($_GET['id'])) {
		$test = $db->selectObject("sanpham","product_type_id=".$_GET['id']);
		if ($test != null) {
	...
	$sanpham=$db->selectObjects("sanpham","product_type_id = {$product_types_id}","postdate DESC LIMIT 0,{$max_product_per_type}");
