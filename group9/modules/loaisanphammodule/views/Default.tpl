<div class="loaisanphammodule default">
	...
	<div class="item">
		...
		{/permissions}
		<div class="text">
			<h2 style="font-size: 14px;"><img src="{$smarty.const.ICON_RELATIVE}bullet_orange.png" border=0><a href="{link action=view_product_by_type module=sanphammodule id=$listing->id}">{$listing->name}</h2>
		</div>
		
	</div>
{foreachelse}
	<div><i>Không có loại sản phẩm nào</i></div>
{/foreach}	
